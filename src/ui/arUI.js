...
export const ALLOWED_TRANSITIONS = {
  [UI_STATES.SCAN_SURFACE]: [UI_STATES.SELECT_SONG_MODE],
  [UI_STATES.SELECT_SONG_MODE]: [UI_STATES.CALIBRATING, UI_STATES.SCAN_SURFACE],
  [UI_STATES.CALIBRATING]: [UI_STATES.COUNTDOWN, UI_STATES.SELECT_SONG_MODE],
  ...
  [UI_STATES.RESULT]: [UI_STATES.SELECT_SONG_MODE, UI_STATES.SCAN_SURFACE, UI_STATES.CALIBRATING]
};
